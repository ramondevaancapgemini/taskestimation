...
public class SemanticActivePageAttributeLinkBehavior extends Behavior {
    private static final long serialVersionUID = 1L;
    private final IPageable pageable;
    private final long      page;

    public SemanticActivePageAttributeLinkBehavior(IPageable pageable, long page) {
    ...
    public void onComponentTag(Component component, ComponentTag tag) {
        Stream<String> classes = Arrays
                .stream(tag.getAttribute("class").split("\\s+"));
